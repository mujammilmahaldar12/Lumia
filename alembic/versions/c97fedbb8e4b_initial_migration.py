...
Revision ID: c97fedbb8e4b
Revises: 
Create Date: 2025-09-25 11:42:19.547726
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('company_id', 'date', name='uix_company_date')
    )
    ...
    sa.ForeignKeyConstraint(['company_id'], ['companies.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('company_id', 'report_date', name='uix_company_report')
    )
